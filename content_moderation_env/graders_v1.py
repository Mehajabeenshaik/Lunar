...
class ModeratorGrader:
    ...
    def grade_task_1(prediction: Dict[str, Any], ground_truth: Dict[str, Any]) -> float:
        ...
        Simple binary accuracy: correct category = 0.99, wrong = 0.01
        """
        try:
    ...
    def grade_task_6(prediction: Dict[str, Any], ground_truth: Dict[str, Any]) -> float:
        ...
        try:
            ...
            scores['action'] = 0.99 if predicted_act == true_act else 0.5  # Partial credit for reasonable actions
        except Exception:
            scores['action'] = 0.01
    ...
    def grade_task_7(prediction: Dict[str, Any], ground_truth: Dict[str, Any]) -> float:
        ...
        Accuracy: correct call = 0.99, wrong call = 0.01
        """
        try:
    ...
    def grade_task_8(prediction: Dict[str, Any], ground_truth: Dict[str, Any]) -> float:
        ...
        try:
            ...
            scores['reasoning'] = 0.99 if good_reasoning else 0.5
        except Exception:
            scores['reasoning'] = 0.01
    ...
    def grade_task_9(prediction: Dict[str, Any], ground_truth: Dict[str, Any]) -> float:
        ...
        try:
            ...
            scores['individual'] = 0.99 if predicted_ind == true_ind else 0.5
        except Exception:
            scores['individual'] = 0.01
